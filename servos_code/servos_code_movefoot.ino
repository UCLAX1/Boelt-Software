...
void readFloatArray(float* data) {
  char buffer[sizeof(float) * 4]; // Change to 16 for all values
...
//  Serial.println(data[3]);
  ...
  // float angles2[] = {data[7], data[6], data[5]}; //second negative
  ...
  //LegFL.move(angles1); //angles2
   //LegBL.move(angles1); //angles3
  LegBR.move(angles1);  //angles4
  delay(75);
  }
}